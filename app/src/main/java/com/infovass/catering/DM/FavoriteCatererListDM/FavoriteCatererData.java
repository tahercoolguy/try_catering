...
public class FavoriteCatererData {
    public String id ;
    ...
    public ArrayList<FavoriteCtrCoverImage> cover_images ;
    public ArrayList<FavoriteCatererMode> modes ;
    public String logo_path ;
    public String cover_image_path ;
    public ArrayList<FavoriteCatererImage> images ;

    public FavoriteCatererData(String id, String created_by, String name, String arabic_name, String detail, String arabic_detail, String status, String female_service, String logo, String cover_image, String time_show, String delivery_charge, String min_order, String setup_time_in_minute, String requirements, String arabic_setup_time_in_minute, String arabic_requirements, String discount_available, String discount_type, String discount_value, String start_date, String end_date, String time, String cash_order_policy, String cancellation_policy, String cancellation_policy_arabic, String is_active, String created_at, String updated_at, String deleted_at, String commission, String minimum_time, String start_time, String end_time, String email, String number_of_review, String rating, boolean offday, String restaurant_Status, boolean is_favorite, ArrayList<FavoriteCtrCoverImage> cover_images, ArrayList<FavoriteCatererMode> modes, String logo_path, String cover_image_path, ArrayList<FavoriteCatererImage> images) {
        this.id = id;
    ...
    public ArrayList<FavoriteCtrCoverImage> getCover_images() {
        return cover_images;
    }

    public void setCover_images(ArrayList<FavoriteCtrCoverImage> cover_images) {
        this.cover_images = cover_images;
    }

    public ArrayList<FavoriteCatererMode> getModes() {
        return modes;
    }

    public void setModes(ArrayList<FavoriteCatererMode> modes) {
        this.modes = modes;
    }
    ...
    public ArrayList<FavoriteCatererImage> getImages() {
        return images;
    }

    public void setImages(ArrayList<FavoriteCatererImage> images) {
        this.images = images;
    }
}
