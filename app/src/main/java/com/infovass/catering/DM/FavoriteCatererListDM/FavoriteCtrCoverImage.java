...
public class FavoriteCtrCoverImage {
    public String id ;
    ...
    public FavoriteCtrCoverImage(String id, String caterer_id, String image, String created_at, String updated_at, String cover_image_path) {
        this.id = id;
