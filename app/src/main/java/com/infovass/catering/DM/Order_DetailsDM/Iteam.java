...
public class Iteam {
    ...
    public String service_and_presentation ;
    ...
    public String arabic_service_and_presentation ;
    public String arabic_food_details ;
