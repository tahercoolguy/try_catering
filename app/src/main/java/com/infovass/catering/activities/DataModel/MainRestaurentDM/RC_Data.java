...
public class RC_Data {
    ...
    private String arabic_detail ;
    private String status ;
    private String female_service ;
    private String logo ;
    private String cover_image ;
    private String time_show ;
    private String delivery_charge ;
    private String min_order ;
    private String setup_time_in_minute ;
    private String requirements ;
    private String arabic_setup_time_in_minute ;
    private String arabic_requirements ;
    ...
    private String time ;
    private String cash_order_policy ;
    private String cancellation_policy ;
    private String cancellation_policy_arabic ;
    ...
    private ArrayList<RC_CoverImage> cover_images ;
    private ArrayList<RC_Mode> modes ;
    private String logo_path ;
    private String cover_image_path ;
    private ArrayList<RC_Image> images ;

    public RC_Data(String id, String created_by, String name, String arabic_name, String detail, String arabic_detail, String status, String female_service, String logo, String cover_image, String time_show, String delivery_charge, String min_order, String setup_time_in_minute, String requirements, String arabic_setup_time_in_minute, String arabic_requirements, String discount_available, String discount_type, String discount_value, String start_date, String end_date, String time, String cash_order_policy, String cancellation_policy, String cancellation_policy_arabic, String is_active, String is_top_ranked, String order, String created_at, String updated_at, String deleted_at, String commission, String minimum_time, String start_time, String end_time, String email, String number_of_review, String rating, String offday, String restaurant_Status, String is_favorite, ArrayList<RC_CoverImage> cover_images, ArrayList<RC_Mode> modes, String logo_path, String cover_image_path, ArrayList<RC_Image> images) {
        this.id = id;
    ...
    public ArrayList<RC_CoverImage> getCover_images() {
        return cover_images;
    }

    public void setCover_images(ArrayList<RC_CoverImage> cover_images) {
        this.cover_images = cover_images;
    }

    public ArrayList<RC_Mode> getModes() {
        return modes;
    }

    public void setModes(ArrayList<RC_Mode> modes) {
        this.modes = modes;
    }
    ...
    public ArrayList<RC_Image> getImages() {
        return images;
    }

    public void setImages(ArrayList<RC_Image> images) {
        this.images = images;
    }
}
