...
public class CatererItem {
    ...
    private String service_and_presentation ;
    private String food_details ;
    private String currency_id ;
    private String item_logo ;
    private String item_status ;
    private String arabic_item_code ;
    private String arabic_item_name ;
    private String arabic_item_display_name ;
    private String arabic_item_short_description ;
    private String arabic_item_long_description ;
    private String arabic_item_cost_per_serve ;
    private String arabic_item_markup_per_serve ;
    private String arabic_item_serving_capacity ;
    private String arabic_setup_time_in_minute ;
    private String arabic_max_time ;
    private String arabic_requirements ;
    private String arabic_service_and_presentation ;
    private String arabic_food_details ;
    ...
    public String getService_and_presentation() {
        return service_and_presentation;
    }

    public void setService_and_presentation(String service_and_presentation) {
        this.service_and_presentation = service_and_presentation;
    }
    ...
    public String getArabic_service_and_presentation() {
        return arabic_service_and_presentation;
    }

    public void setArabic_service_and_presentation(String arabic_service_and_presentation) {
        this.arabic_service_and_presentation = arabic_service_and_presentation;
    }

    public String getArabic_food_details() {
        return arabic_food_details;
    }

    public void setArabic_food_details(String arabic_food_details) {
        this.arabic_food_details = arabic_food_details;
    }
