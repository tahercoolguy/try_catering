...
public class RestourentDetailsImageBanner extends PagerAdapter {
    // Context object
    Context context;

    // Array of images
    // int[] images;
    List<RestourentDetailResponse.cover_images> bookList = new ArrayList<>();
    ...
    public RestourentDetailsImageBanner(Context context, List<RestourentDetailResponse.cover_images> bookList) {
